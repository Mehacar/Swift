...
class ViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if selectedTitle != "" {
            ...
            listofimages.append(UIImage(named: "museum")!)
    ...
    @IBAction func saveButton(_ sender: Any) {
        ...
        newPlace.setValue(nameText.text, forKey: "title") // add the if let controller
        newPlace.setValue(noteText.text, forKey: "subtitle") // add the if let controller // sonra "addtab gesture recog" ile klavye mekaniği ekle
